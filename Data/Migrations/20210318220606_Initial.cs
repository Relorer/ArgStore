        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PriceIncludingDiscount = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GameId = table.Column<int>(type: "int", nullable: true),
                    PurchaseHistoryId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PurchasedGame", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PurchasedGame_Game_GameId",
                        column: x => x.GameId,
                        principalTable: "Game",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PurchasedGame_PurchaseHistory_PurchaseHistoryId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PurchasedGame_GameId",
                table: "PurchasedGame",
                column: "GameId");

            migrationBuilder.CreateIndex(
                name: "IX_PurchasedGame_PurchaseHistoryId",
                table: "PurchasedGame",
